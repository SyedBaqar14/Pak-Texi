...
public class MyNewLocation extends Service implements LocationListener,
    ...
    private static final long MIN_DISTANCE_CHANGE_FOR_UPDATES = 20; //1 meter ; // 10 meters
    ...
    public void GPSTrack(Context context) {
    ...
    public void stopUsingGPS(){
        if(locationManager != null){
            try{
                locationManager.removeUpdates(MyNewLocation.this);
            }catch (SecurityException se){
