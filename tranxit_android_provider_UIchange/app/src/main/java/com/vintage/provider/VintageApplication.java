...
import com.vintage.provider.Utilities.FontsOverride;
...
public class VintageApplication extends Application {
    ...
    public static final String TAG = VintageApplication.class
            .getSimpleName();

    private RequestQueue mRequestQueue;
    private ImageLoader mImageLoader;

    private static VintageApplication mInstance;
...
//        FontsOverride.setDefaultFont(this, "SANS_SERIF", "ClanPro-Book.otf");
    ...
    public static synchronized VintageApplication getInstance() {
        return mInstance;
    }
